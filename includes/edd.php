...
function minimall_edd_di_display_images( $html, $download_image ) {
    ...
    if( $image_id ):
        ...
        $html = '<div class="flex items-start justify-center inline-block col-3 px1 py1"><a href="'. esc_url( $full[0] ) .'"><img class="minimall-edd-thumb zoom-img lazyload" data-src="' . $thumb[0] . '" /></a></div>';
