...
class Minimall_Edd_Download_Comments extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      'minimall_edd_download_comments', // Base ID
      __('Minimall Download Comments', 'minimall'), // Name
      array( 'description' => __( 'Display download comments tabs.', 'minimall' ), ) // Args
    );
  }
  ...
  public function widget( $args, $instance ) {
    ...
    if ( ( comments_open() || get_comments_number() ) ) :
        ...
        comments_template('/template-parts/content-download-comment.php');
