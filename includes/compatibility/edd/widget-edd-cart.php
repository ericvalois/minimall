...
class Minimall_Edd_Download_Cart extends WP_Widget {
  ...
  public function widget( $args, $instance ) {
    $cart_qty = edd_get_cart_quantity();
    ...
    <a <?php echo $display; ?> class="edd-cart-number-of-items text-color line-height-1 hover-opacity flex items-center sm-text" href="<?php echo edd_get_checkout_uri(); ?>"> 
