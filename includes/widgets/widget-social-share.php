 ...
 */
class Minimall_Social_Share_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      'minimall_social_share_widget', // Base ID
      __('Minimall Social Share', 'minimall'), // Name
      array( 'description' => __( 'Display social share links.', 'minimall' ), ) // Args
    );
  }
  ...
  public function widget( $args, $instance ) {
    ...
    echo minimall_get_social_media();
...
} // class Minimall_Social_Share_Widget

// register Minimall_Social_Share_Widget widget
add_action( 'widgets_init', function(){
  register_widget( 'Minimall_Social_Share_Widget' );
});